...
1. From the **Services** menu, select **Cloud9**.
...
1. For **Name**, enter: `cli-lab`

1. Click **Next step** twice, then click **Create environment**.

Cloud9 will take a few minutes to launch the environment. Once it is ready, continue to the next step.

1. Maximize the terminal window by clicking the icon as shown below:
...
1. Press `q` to exit the help page.
...
1. Run this command to generate a unique name:
...
1. Run this command to make a bucket (`mb`):
...
1. Run this command to list the contents of the bucket:
...
1. Run this command to view the contents of the `icon` directory:
...
1. Run this command to delete the S3 bucket and its content:
...
1. Run this command, which includes a `--filter` argument:
...
1. Run this command, which includes a `--query` argument:
...
1. Run this command, which includes an `--output` argument:
...
1. Run this command to view the results as a formatted table:
...
1. Run this command to sort the output by date:
...
1. Run this command (copy and paste all lines together):
